  ...
  run: async (client, message, args, cmduser, text, prefix, player, es, ls) => {
    ...
    var components = [
      new MessageActionRow().addComponents([
        ...
        .addOptions(["Mr.Barber", "Amin Senator", "Nima", "RapFarsi New", "Best Persian Pop", "Best Persian Pop 2025", "Best RapFarsi", "Best Old Irani", "Rap Dep", "Chill", "Default"].map((t, index) => {
          return {
            label: t.substr(0, 25),
            value: t.substr(0, 25),
