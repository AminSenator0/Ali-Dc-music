      ...
      try {
        ...
        switch (data.eq) {
          ...
          case `🔈 Earrape`:
            ...
            await player.setVolume(player.volume + 100);
            ...
            if (i.customId == `4`) {
              ...
              i.reply({
                embeds: [new MessageEmbed()
                  .setColor(es.color)
                  .setTimestamp()
                  .setTitle(`${player.get(`autoplay`) ? `<:21:1070256823174713364> **Enabled Autoplay**`: `❌ **Disabled Autoplay**`}`)
                  .setFooter(client.getFooter(`💢 Action by: ${member.user.tag}`, member.user.displayAvatarURL({
                    dynamic: true
                  })))
                ]
            ...
            if (i.customId == `6`) {
              ...
              i.reply({
                embeds: [new MessageEmbed()
                  .setColor(es.color)
                  .setTimestamp()
                  .setTitle(`${player.trackRepeat ? `<:21:1070256823174713364> **Enabled Song Loop**`: `❌ **Disabled Song Loop**`}`)
                  .setFooter(client.getFooter(`💢 Action by: ${member.user.tag}`, member.user.displayAvatarURL({
                    dynamic: true
                  })))
                ]
            ...
            if (i.customId == `7`) {
              ...
              i.reply({
                embeds: [new MessageEmbed()
                  .setColor(es.color)
                  .setTimestamp()
                  .setTitle(`${player.queueRepeat ? `<:21:1070256823174713364> **Enabled Queue Loop**`: `❌ **Disabled Queue Loop**`}`)
                  .setFooter(client.getFooter(`💢 Action by: ${member.user.tag}`, member.user.displayAvatarURL({
                    dynamic: true
                  })))
                ]
