      ...
      if(user) {
        ...
        interaction.reply({ephemeral: true, 
          embeds: [new MessageEmbed()
            ...
            .setFooter(client.getFooter(`${user.username} | powered by Black Holes`, "https://media.discordapp.net/attachments/853648072986066976/926090047873224734/ezgifcom-gif-maker-8.gif"))],
        ...
        interaction.reply({ephemeral: true, 
          embeds: [new MessageEmbed()
            ...
            .setFooter(`${client.user.username} | powered by Black Holes`, "https://media.discordapp.net/attachments/853648072986066976/926090047873224734/ezgifcom-gif-maker-8.gif")],
          components: allbuttons
        });
      }
    } catch (e) {
